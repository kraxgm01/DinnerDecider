...
public final class UnsignedKt {
    ...
    public static final int m376uintDivideJ1ME1BU(int v1, int v2) {
        return UInt.m123constructorimpl((int) ((((long) v1) & 4294967295L) / (4294967295L & ((long) v2))));
    }

    /* renamed from: uintRemainder-J1ME1BU  reason: not valid java name */
    public static final int m377uintRemainderJ1ME1BU(int v1, int v2) {
        return UInt.m123constructorimpl((int) ((((long) v1) & 4294967295L) % (4294967295L & ((long) v2))));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m378ulongDivideeb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
    ...
    public static final long m379ulongRemaindereb3DHEI(long v1, long v2) {
        long dividend = v1;
        long divisor = v2;
        long j = 0;
        if (divisor < 0) {
            ...
            return ULong.m201constructorimpl(v1 - v2);
        } else if (dividend >= 0) {
            return ULong.m201constructorimpl(dividend % divisor);
        } else {
            ...
            return ULong.m201constructorimpl(rem - j);
        }
    }
    ...
    public static final int doubleToUInt(double v) {
        ...
        if (v <= 2.147483647E9d) {
            return UInt.m123constructorimpl((int) v);
        }
        return UInt.m123constructorimpl(UInt.m123constructorimpl((int) (v - ((double) Integer.MAX_VALUE))) + UInt.m123constructorimpl(Integer.MAX_VALUE));
    }
