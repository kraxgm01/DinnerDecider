...
public abstract class AbstractDoubleTimeSource implements TimeSource {
    ...
    private static final class DoubleTimeMark extends TimeMark {
        ...
        public TimeMark m1305plusLRDsOJo(long duration) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m1351plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
