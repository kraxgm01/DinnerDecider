...
final class AdjustedTimeMark extends TimeMark {
    ...
    public final long m1309getAdjustmentUwyO8pc() {
    ...
    public long m1308elapsedNowUwyO8pc() {
        return Duration.m1350minusLRDsOJo(this.mark.m1444elapsedNowUwyO8pc(), m1309getAdjustmentUwyO8pc());
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1310plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1351plusLRDsOJo(m1309getAdjustmentUwyO8pc(), duration), (DefaultConstructorMarker) null);
    }
}
