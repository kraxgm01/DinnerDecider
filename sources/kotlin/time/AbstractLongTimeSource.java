...
public abstract class AbstractLongTimeSource implements TimeSource {
    ...
    private static final class LongTimeMark extends TimeMark {
        ...
        public long m1306elapsedNowUwyO8pc() {
        ...
        public TimeMark m1307plusLRDsOJo(long duration) {
            return new LongTimeMark(this.startedAt, this.timeSource, Duration.m1351plusLRDsOJo(this.offset, duration), (DefaultConstructorMarker) null);
        }
    }
