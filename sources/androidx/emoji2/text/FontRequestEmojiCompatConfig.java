    ...
    private static class FontRequestMetadataLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        public void createMetadata() {
            /*
                ...
                monitor-enter(r0)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r1 = r7.mCallback     // Catch:{ all -> 0x00a9 }
                if (r1 != 0) goto L_0x0009
                monitor-exit(r0)     // Catch:{ all -> 0x00a9 }
                return
            L_0x0009:
                monitor-exit(r0)     // Catch:{ all -> 0x00a9 }
                androidx.core.provider.FontsContractCompat$FontInfo r0 = r7.retrieveFontInfo()     // Catch:{ all -> 0x0095 }
                int r1 = r0.getResultCode()     // Catch:{ all -> 0x0095 }
                r2 = 2
                if (r1 != r2) goto L_0x0034
                java.lang.Object r2 = r7.mLock     // Catch:{ all -> 0x0095 }
            ...
            L_0x0095:
                ...
                monitor-enter(r2)
                androidx.emoji2.text.EmojiCompat$MetadataRepoLoaderCallback r0 = r7.mCallback     // Catch:{ all -> 0x00a6 }
