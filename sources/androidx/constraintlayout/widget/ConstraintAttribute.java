        ...
        for (String name : base.keySet()) {
            ...
            try {
                if (name.equals("BackgroundColor")) {
                    ...
                    ret.put(name, new ConstraintAttribute(constraintAttribute, cls.getMethod(valueOf.length() != 0 ? "getMap".concat(valueOf) : new String("getMap"), new Class[0]).invoke(view, new Object[0])));
                }
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> map) {
        ...
        for (String name : map.keySet()) {
            ...
            try {
                ...
                StringBuilder sb2 = new StringBuilder(String.valueOf(name3).length() + 20 + String.valueOf(methodName).length());
                sb2.append(name3);
