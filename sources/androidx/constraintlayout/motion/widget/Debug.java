...
import com.kalyan.dinnerdecider.BuildConfig;
...
public class Debug {
    ...
    public static String getState(MotionLayout layout, int stateId, int len) {
        ...
        return str.replaceAll(String.valueOf(CharBuffer.allocate((str.length() - len) / n).toString().replace(0, '.')).concat("_"), "_");
    }
                ...
                try {
                    ...
                    if (declaredField.getName().contains("To")) {
                        if (!value.toString().equals("-1")) {
                            ...
                            String valueOf = String.valueOf(value);
                            Object obj = value;
                            StringBuilder sb4 = new StringBuilder(String.valueOf(loc).length() + 8 + String.valueOf(name2).length() + String.valueOf(valueOf).length());
                            sb4.append(loc);
                            sb4.append("       ");
                            sb4.append(name2);
                            sb4.append(" ");
