...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayoutParam(String str, ConstraintLayout.LayoutParams params) {
            ...
            String str2 = "|__";
            String valueOf4 = String.valueOf(params.startToEnd != -1 ? "|SE" : str2);
            String valueOf5 = String.valueOf(valueOf4.length() != 0 ? valueOf3.concat(valueOf4) : new String(valueOf3));
            String valueOf6 = String.valueOf(params.endToStart != -1 ? "|ES" : str2);
            String valueOf7 = String.valueOf(valueOf6.length() != 0 ? valueOf5.concat(valueOf6) : new String(valueOf5));
            String valueOf8 = String.valueOf(params.endToEnd != -1 ? "|EE" : str2);
            String valueOf9 = String.valueOf(valueOf8.length() != 0 ? valueOf7.concat(valueOf8) : new String(valueOf7));
            String valueOf10 = String.valueOf(params.leftToLeft != -1 ? "|LL" : str2);
            String valueOf11 = String.valueOf(valueOf10.length() != 0 ? valueOf9.concat(valueOf10) : new String(valueOf9));
            String valueOf12 = String.valueOf(params.leftToRight != -1 ? "|LR" : str2);
            String valueOf13 = String.valueOf(valueOf12.length() != 0 ? valueOf11.concat(valueOf12) : new String(valueOf11));
            String valueOf14 = String.valueOf(params.rightToLeft != -1 ? "|RL" : str2);
            String valueOf15 = String.valueOf(valueOf14.length() != 0 ? valueOf13.concat(valueOf14) : new String(valueOf13));
            String valueOf16 = String.valueOf(params.rightToRight != -1 ? "|RR" : str2);
            String valueOf17 = String.valueOf(valueOf16.length() != 0 ? valueOf15.concat(valueOf16) : new String(valueOf15));
            String valueOf18 = String.valueOf(params.topToTop != -1 ? "|TT" : str2);
            String valueOf19 = String.valueOf(valueOf18.length() != 0 ? valueOf17.concat(valueOf18) : new String(valueOf17));
            String valueOf20 = String.valueOf(params.topToBottom != -1 ? "|TB" : str2);
            String valueOf21 = String.valueOf(valueOf20.length() != 0 ? valueOf19.concat(valueOf20) : new String(valueOf19));
            String valueOf22 = String.valueOf(params.bottomToTop != -1 ? "|BT" : str2);
            ...
            String valueOf24 = String.valueOf(str2);
            String a = valueOf24.length() != 0 ? valueOf23.concat(valueOf24) : new String(valueOf23);
        ...
        private void debugWidget(String str, ConstraintWidget child) {
            ...
            if (child.mTop.mTarget != null) {
                String valueOf2 = String.valueOf(child.mTop.mTarget.mType == ConstraintAnchor.Type.TOP ? str5 : "B");
                str2 = valueOf2.length() != 0 ? str5.concat(valueOf2) : new String(str5);
            } else {
                str2 = str6;
            }
            String valueOf3 = String.valueOf(str2);
            String valueOf4 = String.valueOf(valueOf3.length() != 0 ? valueOf.concat(valueOf3) : new String(valueOf));
            ...
            String valueOf7 = String.valueOf(valueOf6.length() != 0 ? valueOf4.concat(valueOf6) : new String(valueOf4));
            String str7 = "L";
            if (child.mLeft.mTarget != null) {
                String valueOf8 = String.valueOf(child.mLeft.mTarget.mType == ConstraintAnchor.Type.LEFT ? str7 : "R");
                str4 = valueOf8.length() != 0 ? str7.concat(valueOf8) : new String(str7);
            } else {
                str4 = str6;
            }
            String valueOf9 = String.valueOf(str4);
            String valueOf10 = String.valueOf(valueOf9.length() != 0 ? valueOf7.concat(valueOf9) : new String(valueOf7));
            ...
            String a = valueOf12.length() != 0 ? valueOf10.concat(valueOf12) : new String(valueOf10);
            String valueOf13 = String.valueOf(child);
            StringBuilder sb = new StringBuilder(String.valueOf(str).length() + 6 + String.valueOf(a).length() + String.valueOf(valueOf13).length());
            sb.append(str);
            sb.append(a);
            sb.append(" ---  ");
            sb.append(valueOf13);
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String str2 = "_";
                String valueOf3 = String.valueOf(child.mTop.mTarget != null ? "T" : str2);
                String valueOf4 = String.valueOf(valueOf3.length() != 0 ? valueOf2.concat(valueOf3) : new String(valueOf2));
                String valueOf5 = String.valueOf(child.mBottom.mTarget != null ? "B" : str2);
                String valueOf6 = String.valueOf(valueOf5.length() != 0 ? valueOf4.concat(valueOf5) : new String(valueOf4));
                String valueOf7 = String.valueOf(child.mLeft.mTarget != null ? "L" : str2);
                ...
                String a = valueOf9.length() != 0 ? valueOf8.concat(valueOf9) : new String(valueOf8);
                ...
                StringBuilder sb5 = new StringBuilder(String.valueOf(str).length() + 4 + String.valueOf(name2).length() + String.valueOf(valueOf12).length() + String.valueOf(a).length());
                sb5.append(str);
                sb5.append("  ");
                sb5.append(name2);
                sb5.append(" ");
                ...
                if (motionController2 == null) {
                    ...
                    if (this.mStart != null) {
                        ...
                        if (startWidget != null) {
                            ...
                            ConstraintWidget constraintWidget = startWidget;
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            sb.append(((float) ((int) ((len * 100.0f) / dist))) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            StringBuilder sb = new StringBuilder(15);
            sb.append(((float) ((int) (((double) ((xgap * 100.0f) / Math.abs(x2 - x1))) + 0.5d))) / 100.0f);
            String text = sb.toString();
            getTextBounds(text, this.mTextPaint);
            ...
            sb2.append(((float) ((int) (((double) ((ygap * 100.0f) / Math.abs(y2 - y1))) + 0.5d))) / 100.0f);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            ...
            float ygap = y;
            StringBuilder sb = new StringBuilder(15);
            sb.append(((float) ((int) (((double) (((xgap - ((float) (viewWidth / 2))) * 100.0f) / ((float) (MotionLayout.this.getWidth() - viewWidth)))) + 0.5d))) / 100.0f);
            String text = sb.toString();
            getTextBounds(text, this.mTextPaint);
            ...
            StringBuilder sb2 = new StringBuilder(15);
            sb2.append(((float) ((int) (((double) (((ygap - ((float) (viewHeight / 2))) * 100.0f) / ((float) (MotionLayout.this.getHeight() - viewHeight)))) + 0.5d))) / 100.0f);
            String text2 = sb2.toString();
            getTextBounds(text2, this.mTextPaint);
    ...
    public void dispatchDraw(Canvas canvas) {
        ...
        if (this.mScene != null) {
            if ((this.mDebugPath & 1) == 1 && !isInEditMode()) {
                ...
                float p = ((float) ((int) (getProgress() * 1000.0f))) / 10.0f;
